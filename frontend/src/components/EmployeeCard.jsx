...
<div id={props.name} className="max-w-sm bg-[#233775] text-white rounded-lg overflow-hidden shadow-lg mx-4 my-4 transform transition duration-300 hover:scale-105" >
  <div className="flex items-center p-4">
    ...
    alt="logo" className="w-12 h-12 mr-4" />
